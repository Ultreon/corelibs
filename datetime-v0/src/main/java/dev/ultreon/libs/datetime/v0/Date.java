...
import static dev.ultreon.libs.datetime.v0.MeteorologicalSeason.*;
...
public class Date implements Serializable, Comparable<Date>, Cloneable {
    ...
    public static Date current() {
        ...
        return new Date(day, dev.ultreon.libs.datetime.v0.Month.from(month), year);
    }

    public Date(int day, int month, int year) {
        this(day, dev.ultreon.libs.datetime.v0.Month.from(month), year);
    }

    public Date(int day, dev.ultreon.libs.datetime.v0.Month month, int year) {
    ...
    static void checkDayOfMonth(int day, dev.ultreon.libs.datetime.v0.Month month, int year) {
    ...
    public void setMonth(dev.ultreon.libs.datetime.v0.Month month) {
        this.month = month;
    }
